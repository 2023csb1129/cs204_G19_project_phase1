...
void write_data_memory() {
  ...
  if (fp == NULL) {
    printf("Error opening data_out.mem for writing\n");
    return;
  }
...
void fetch() {
  ...
  printf("FETCH: Fetch instruction 0x%08X from address 0x%08X\n", IR, PC);
}

void decode() {
  unsigned int opcode = OPCODE(IR);
  if (IR == 0xEF000011) {
    printf("DECODE: Exit instruction encountered\n");
    swi_exit();
  }
  ...
  if (opcode == 0x33) { // R-type instructions
    ...
    if (funct3 == 0x0 && funct7 == 0x00) {
      printf("DECODE: Operation is ADD, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x0 && funct7 == 0x20) {
      printf("DECODE: Operation is SUB, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x7 && funct7 == 0x00) {
      printf("DECODE: Operation is AND, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x6 && funct7 == 0x00) {
      printf("DECODE: Operation is OR, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x1 && funct7 == 0x00) {
      printf("DECODE: Operation is SLL, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x5 && funct7 == 0x00) {
      printf("DECODE: Operation is SRL, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x4 && funct7 == 0x00) {
      printf("DECODE: Operation is XOR, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x2 && funct7 == 0x00) {
      printf("DECODE: Operation is SLT, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x5 && funct7 == 0x20) {
      printf("DECODE: Operation is SRA, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x0 && funct7 == 0x01) {
      printf("DECODE: Operation is MUL, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x4 && funct7 == 0x01) {
      printf("DECODE: Operation is DIV, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x6 && funct7 == 0x01) {
      printf("DECODE: Operation is REM, operands R%d and R%d, destination R%d\n", rs1, rs2, rd);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
  }
    ...
    if (funct3 == 0x1 || funct3 == 0x5) {
      ...
      if (funct3 == 0x1) {
         ...
         printf("DECODE: Operation is SLLI, source register R%d, shamt %d, destination register R%d\n", rs1, shamt, rd);
      } else { // funct3 == 0x5
         unsigned int funct7 = (IR >> 25) & 0x7F;
         if (funct7 == 0x00) {
           printf("DECODE: Operation is SRLI, source register R%d, shamt %d, destination register R%d\n", rs1, shamt, rd);
         } else if (funct7 == 0x20) {
           printf("DECODE: Operation is SRAI, source register R%d, shamt %d, destination register R%d\n", rs1, shamt, rd);
         }
      }
    } else {
       int imm = (IR >> 20) & 0xFFF;
       ...
       dest_reg = rd;
       if (funct3 == 0x0) {
         printf("DECODE: Operation is ADDI, source register R%d, immediate %d, destination register R%d\n", rs1, imm, rd);
         printf("DECODE: Read register R%d = %d\n", rs1, operand1);
       }
       else if (funct3 == 0x2) {
         printf("DECODE: Operation is SLTI, compare R%d < %d, destination register R%d\n", rs1, imm, rd);
         printf("DECODE: Read register R%d = %d\n", rs1, operand1);
       }
       else if (funct3 == 0x7) {
         printf("DECODE: Operation is ANDI, source register R%d, immediate %d, destination register R%d\n", rs1, imm, rd);
         printf("DECODE: Read register R%d = %d\n", rs1, operand1);
       }
       else if (funct3 == 0x6) {
         printf("DECODE: Operation is ORI, source register R%d, immediate %d, destination register R%d\n", rs1, imm, rd);
         printf("DECODE: Read register R%d = %d\n", rs1, operand1);
       }
    }
  }
    ...
    if (funct3 == 0x2) {
      printf("DECODE: Operation is LW, base register R%d, offset %d, destination register R%d\n", rs1, imm, rd);
      printf("DECODE: Read base register R%d = %d\n", rs1, operand1);
    }
    else if (funct3 == 0x0) {
      printf("DECODE: Operation is LB, base register R%d, offset %d, destination register R%d\n", rs1, imm, rd);
      printf("DECODE: Read base register R%d = %d\n", rs1, operand1);
    }
    else if (funct3 == 0x1) {
      printf("DECODE: Operation is LH, base register R%d, offset %d, destination register R%d\n", rs1, imm, rd);
      printf("DECODE: Read base register R%d = %d\n", rs1, operand1);
    }
  }
    ...
    if (funct3 == 0x2) {
      printf("DECODE: Operation is SW, base register R%d, source register R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d (base), R%d = %d (value)\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x0) {
      printf("DECODE: Operation is SB, base register R%d, source register R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d (base), R%d = %d (value)\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x1) {
      printf("DECODE: Operation is SH, base register R%d, source register R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d (base), R%d = %d (value)\n", rs1, operand1, rs2, operand2);
    }
  }
    ...
    if (funct3 == 0x0) {
      printf("DECODE: Operation is BEQ, compare R%d and R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    } else if (funct3 == 0x1) {
      printf("DECODE: Operation is BNE, compare R%d and R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x4) {
      printf("DECODE: Operation is BLT, compare R%d < R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
    else if (funct3 == 0x5) {
      printf("DECODE: Operation is BGE, compare R%d >= R%d, offset %d\n", rs1, rs2, imm);
      printf("DECODE: Read R%d = %d, R%d = %d\n", rs1, operand1, rs2, operand2);
    }
  }
    ...
    dest_reg = rd;
    operand1 = PC;
    printf("DECODE: Operation is JAL, rd = R%d, offset = %d\n", rd, imm);
  }
    ...
    operand2 = imm;
    dest_reg = rd;
    printf("DECODE: Operation is JALR, rd = R%d, rs1 = R%d, offset = %d\n", rd, rs1, imm);
    printf("DECODE: Read R%d = %d\n", rs1, operand1);
  }
    ...
    alu_result = imm;
    dest_reg = rd;
    printf("DECODE: Operation is LUI, immediate = %d, destination register R%d\n", imm, rd);
  }
    ...
    alu_result = PC + imm;
    dest_reg = rd;
    printf("DECODE: Operation is AUIPC, PC = %d, immediate = %d, destination R%d\n", PC, imm, rd);
  }
}
...
void execute() {
  ...
  if (opcode == 0x33 && funct3 == 0x0 && funct7 == 0x00) {
    ...
    if (operand2 != 0) {
      ...
      alu_result = 0;
      printf("EXECUTE: DIV by zero, result set to 0\n");
    }
  }
  else if (opcode == 0x33 && funct3 == 0x6 && funct7 == 0x01) {  // REM
    if (operand2 != 0) {
      alu_result = (int)operand1 % (int)operand2;
      printf("EXECUTE: REM %d %% %d = %d\n", operand1, operand2, alu_result);
    } else {
      alu_result = 0;
      printf("EXECUTE: REM by zero, result set to 0\n");
    }
  }
}
...
/* 
   Note: The main() function has been moved to main.c as per the project template.
*/
